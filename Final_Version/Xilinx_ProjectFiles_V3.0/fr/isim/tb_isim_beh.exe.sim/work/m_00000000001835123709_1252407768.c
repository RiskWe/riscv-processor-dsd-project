...
#endif
static const char *ng0 = "C:/Users/ruchi/Downloads/RISC-V-32I-5-stage-Pipeline-Core-main(1)/RISC-V-32I-5-stage-Pipeline-Core-main/src/Sign_Extend.v";
...
LAB20:    t129 = (t0 + 2928);
    ...
    t133 = *((char **)t132);
    memcpy(t133, t3, 8);
    xsi_driver_vfirst_trans(t129, 0, 31);
    t134 = (t0 + 2848);
    *((int *)t134) = 1;
