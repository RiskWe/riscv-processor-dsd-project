...
#endif
static const char *ng0 = "C:/Users/ruchi/Downloads/RISC-V-32I-5-stage-Pipeline-Core-main(1)/RISC-V-32I-5-stage-Pipeline-Core-main/src/Hazard_unit.v";
...
LAB20:    t311 = (t0 + 4152);
    ...
    *((unsigned int *)t321) = (t323 | t317);
    xsi_driver_vfirst_trans(t311, 0, 1);
    t324 = (t0 + 4056);
    *((int *)t324) = 1;
...
LAB71:    if (*((unsigned int *)t294) != 0)
        goto LAB72;

LAB73:    t301 = (t175 + 4);
    t302 = *((unsigned int *)t175);
    t303 = *((unsigned int *)t301);
    t304 = (t302 || t303);
    if (t304 > 0)
        goto LAB74;

LAB75:    t306 = *((unsigned int *)t175);
    t307 = (~(t306));
...
LAB81:    memcpy(t174, t310, 8);

LAB82:    goto LAB46;

LAB47:    xsi_vlog_unsigned_bit_combine(t38, 2, t169, 2, t174, 2);
    goto LAB51;

LAB49:    memcpy(t38, t169, 8);
    goto LAB51;
...
LAB78:    xsi_vlog_unsigned_bit_combine(t174, 2, t305, 2, t310, 2);
    goto LAB82;

LAB80:    memcpy(t174, t305, 8);
    goto LAB82;
...
extern void work_m_00000000003808576811_0569471234_init()
{
	static char *pe[] = {(void *)Cont_9_0,(void *)Cont_13_1};
	xsi_register_didat("work_m_00000000003808576811_0569471234", "isim/tb_isim_beh.exe.sim/work/m_00000000003808576811_0569471234.didat");
